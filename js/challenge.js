...
const pause_id = document.getElementById("pause")
const minus_id = document.getElementById("minus")
const plus_id = document.getElementById("plus")
const heart_id = document.getElementById("heart")
const list_id = document.getElementById("list")
const comments = document.getElementsByTagName("form")[0]
...
comments.addEventListener("submit",function(a){
    a.preventDefault()
